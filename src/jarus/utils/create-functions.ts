          ...
          RiskItems: members.map((member: any, index: any) => ({
            ...
            Attributes: [
              ...
              },
              {
                ...
                ChoiceValue: member.nationality?.code || 'SA',
                ActionCode: 0,
                MarkForDeletion: 0,
              },
              {
                ...
                ChoiceValue: member.relation?.code || 'Empl',
                ActionCode: 0,
                MarkForDeletion: 0,
              },
              {
                ...
                ChoiceValue: member.occupation?.code || '01',
                ActionCode: 0,
                MarkForDeletion: 0,
              },
              {
                ...
                ChoiceValue: member.marital_status?.code || 'S',
                ActionCode: 0,
                MarkForDeletion: 0,
              },
              {
